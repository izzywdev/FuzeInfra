...
class TestRepoFromConfigUrl(unittest.TestCase):
    def _check(self, url, expected):
        self.assertEqual(rh.repo_from_config_url(url), expected)

    def test_full_url(self):
        self._check("https://github.com/izzywdev/FuzePlan", "izzywdev/FuzePlan")

    def test_trailing_slash(self):
        self._check("https://github.com/izzywdev/FuzePlan/", "izzywdev/FuzePlan")

    def test_org_level_url_returns_none(self):
        self._check("https://github.com/izzywdev", None)
    ...
    def test_non_url_returns_none(self):
        self._check("not a url", None)


class TestScaleSetMapping(unittest.TestCase):
...
class TestEvaluate(unittest.TestCase):
    ...
    def test_stranded_count_matches_the_nodes_printed_beside_it(self):
        ...
        self.assertIn("2 of 2", finding.message, finding.message)
...
class TestWorkflow(unittest.TestCase):
    ...
    def test_probe_does_not_run_inside_the_cluster_it_monitors(self):
        ...
        """
        runs_on = self._workflow()["jobs"]["probe"]["runs-on"]
        self.assertEqual(
            runs_on,
            "ubuntu-latest",
    ...
    def test_probe_runs_on_a_schedule(self):
        ...
        triggers = self._workflow()[True]  # YAML parses the `on:` key as the boolean True
